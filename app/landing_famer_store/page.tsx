    ...
    async function fetchMyStore() {
      try {
        ...
        setStore({
          id: myStore.id,
          name: myStore.name,
          image: myStore.imageUrl,
          description: myStore.description,
          rating: myStore.rating,
        });

        setProducts(myStore.products || []);
        setFilteredProducts(myStore.products || []);
      } catch (err: any) {
        console.error("Error fetching store:", err);
        setError("获取商店信息失败: " + (err.message || "未知错误"));
      } finally {
        setLoading(false);
      }
    }
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <section className="relative h-[400px] w-full flex items-center justify-center">
        ...
        <div className="absolute inset-0">
          <img
            src={store?.image || '/placeholder-product.png'}

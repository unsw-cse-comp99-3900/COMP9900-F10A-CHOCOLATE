  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      try {
        ...
        // Fetch product details with store and owner information
        const productUrl = `${process.env.NEXT_PUBLIC_API_URL}/products/${id}`;
        ...
        if (productData.category) {
          const similarUrl = `${process.env.NEXT_PUBLIC_API_URL}/products?category=${productData.category}&limit=3`;
        ...
        <div className="bg-white shadow-md rounded-lg flex flex-col md:flex-row gap-12 items-center p-8">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-6">
            ...
            <p className="text-gray-600 text-xl">
              Farmer: <span className="font-semibold">
                {product.store?.owner?.name || "Unknown Farmer"}
              </span>
            </p>

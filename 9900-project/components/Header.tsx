...
const Header = () => {
  ...
  return (
    <CartProvider refreshCart={refreshCart}>
            ...
            <div className="flex items-center">
              <div className="relative">
                <Link href="/cart" className="text-3xl">
                  <ShoppingCart size={25} className={cartLoading ? "animate-pulse" : ""} />
                  {totalItems > 0 && (
              ...
              <div className="ml-2">
                ...
                <div>{cartLoading ? "Loading..." : `AUD $${totalPrice.toFixed(2)}`}</div>
              </div>
            </div>
          </div>
        </div>
